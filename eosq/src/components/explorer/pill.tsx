...
import { Box } from "@dfuse/explorer/dist/lib/components/atoms/box";
import { Cell } from "@dfuse/explorer/dist/lib/components/atoms/cell";
...
import {
  ...
  PillLogo,
  PillWithRigthInfo,
} from "@dfuse/explorer/dist/lib/components/pills/pill-elements";
...
export class Pill extends React.Component<Props, State> {
  ...
  */
  ...
  renderOverviewRow() {
    return (
      <PillOverviewRow
        bg={this.props.failed ?  ((theme as any).colors.pillErrorBackground||"#FF91A0") : this.props.highlighted ? ((theme as any).colors.pillHighlightedBackground||"lightyellow") :  ((theme as any).colors.pillBackground||"white")}
        minHeight="26px"
      >
        {this.props.pill2}
        {this.props.content}
          ...
          >
            <PillContainerDetails>
              ...
              <PillInfoContainer withBorderBottom={infoSection != null}>
                <Cell bg={(theme.colors as any).transactionHeaderAttentionBackground||"#fff"} p={infoPadding}>{infoSection}</Cell>
              </PillInfoContainer>
