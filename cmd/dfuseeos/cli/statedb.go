...
func init() {
	launcher.RegisterApp(&launcher.AppDef{
		...
		RegisterFlags: func(cmd *cobra.Command) error {
			...
			cmd.Flags().String("statedb-reproc-shard-store-url", "file://{zswlishi-data-dir}/statedb/reproc-shards", "[BATCH] Storage url where all reproc shard write requests should be written to")
