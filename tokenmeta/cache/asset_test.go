...
func Test_compareOwnedAssetBySymbol(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			order:       ASC,
			a:           &OwnedAsset{Owner: "eoscanadadad", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
		...
		},
		{
			...
			order:       ASC,
			a:           &OwnedAsset{Owner: "eoscanadadad", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "WAX")}},
		...
		},
		{
			...
			order:       ASC,
			a:           &OwnedAsset{Owner: "eosaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "eoscanadadad", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			expectValue: true,
		},
		{
		...
		},
		{
			...
			order:       DESC,
			a:           &OwnedAsset{Owner: "eoscanadadad", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "eosaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			expectValue: false,
		},
	}
...
func Test_compareOwnedAssetByAccount(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:        "ascending a before b",
			order:       ASC,
			a:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			expectValue: true,
		},
		{
			name:        "ascending a after b",
			order:       ASC,
			a:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			expectValue: false,
		},
		{
			...
			order:       ASC,
			a:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "WAX")}},
			expectValue: true,
		},
		{
		...
		},
		{
			...
			order:       DESC,
			a:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "WAX")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			expectValue: false,
		},
		{
...
func Test_compareOwnedAssetByTokenAmount(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:        "ascending a before b",
			order:       ASC,
			a:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(32, "EOS")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(84, "EOS")}},
			expectValue: true,
		},
		{
			name:        "ascending a after b",
			order:       ASC,
			a:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			b:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(32, "EOS")}},
			expectValue: false,
		},
		{
			name:        "ascending a equal b, should sort by accounting",
			order:       ASC,
			a:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			expectValue: true,
		},
		{
		...
		},
		{
			...
			order:       DESC,
			a:           &OwnedAsset{Owner: "aaaaaaaaaaaa", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(100, "EOS")}},
			expectValue: false,
		},
		{
			name:        "descending a equal b, should sort by symbol",
		...
		},
		{
			name:        "descending a equal b, should sort by owner if contract is equal",
			order:       DESC,
			a:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "zswhq.token", Asset: generateTestAsset(23, "EOS")}},
			b:           &OwnedAsset{Owner: "bbbbbbbbbbbb", Asset: &eos.ExtendedAsset{Contract: "b1tokenmeta", Asset: generateTestAsset(23, "EOS")}},
			expectValue: false,
		},
	}
