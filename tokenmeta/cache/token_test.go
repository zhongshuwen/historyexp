...
func Test_SortTokensSymbolAlpha(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			order: ASC,
			tokens: []*pbtokenmeta.Token{
				{Contract: "zswhq.token", Symbol: "EOS", Holders: 8},
				{Contract: "zswhq.token", Symbol: "WAL", Holders: 2},
...
func Test_compareTokenBySymbol(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			order:       ASC,
			a:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "EOS", Holders: 8},
			b:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "WAL", Holders: 8},
			expectValue: true,
		},
		{
			name:        "ascending a after b",
			order:       ASC,
			a:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "WAL", Holders: 8},
			b:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "EOS", Holders: 8},
			expectValue: false,
		},
		{
			...
			b:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "TNT", Holders: 8},
			expectValue: true,
		},
		{
...
func Test_compareTokenByHolders(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:        "descending a after b",
			order:       DESC,
			a:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "EOS", Holders: 3},
			b:           &pbtokenmeta.Token{Contract: "bonecoin.en", Symbol: "WAL", Holders: 8},
			expectValue: false,
		},
		{
